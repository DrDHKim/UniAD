...
# 세션 35: slowstop v2 (500씬 추가) + 전환 윈도우 10x 오버샘플
# 전환 프레임 비율: 46.4%, 총 77,372 샘플, 1,127씬
# 이전 버전: carla_infos_train_oversample.pkl (3x, 33,535 샘플)
ann_file_train = info_root + 'carla_infos_train_slowstop_v2_10x.pkl'
...
max_cache_scenes   = 9999                      # 세션 35: 파티션 확장(200→300GB)으로 전체 캐시 가능
